...
import es.vass.pets.polymer.config.Constants;
import com.codahale.metrics.annotation.Timed;
import es.vass.pets.polymer.domain.Authority;
import es.vass.pets.polymer.domain.User;
import es.vass.pets.polymer.repository.AuthorityRepository;
import es.vass.pets.polymer.repository.UserRepository;
import es.vass.pets.polymer.security.AuthoritiesConstants;
import es.vass.pets.polymer.service.MailService;
import es.vass.pets.polymer.service.UserService;
import es.vass.pets.polymer.web.rest.dto.ManagedUserDTO;
import es.vass.pets.polymer.web.rest.util.HeaderUtil;
import es.vass.pets.polymer.web.rest.util.PaginationUtil;
