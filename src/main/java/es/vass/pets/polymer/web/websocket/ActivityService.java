package es.vass.pets.polymer.web.websocket;

import es.vass.pets.polymer.security.SecurityUtils;
import es.vass.pets.polymer.web.websocket.dto.ActivityDTO;
...
import static es.vass.pets.polymer.config.WebsocketConfiguration.IP_ADDRESS;
