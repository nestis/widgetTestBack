package es.vass.pets.polymer.config;

import com.github.mongobee.Mongobee;
import com.mongodb.Mongo;
import es.vass.pets.polymer.domain.util.JSR310DateConverters.*;
...
@Configuration
@EnableMongoRepositories("es.vass.pets.polymer.repository")
...
public class CloudMongoDbConfiguration extends AbstractMongoConfiguration  {
    ...
    public Mongobee mongobee() throws Exception {
        ...
        mongobee.setChangeLogsScanPackage("es.vass.pets.polymer.config.dbmigrations");
